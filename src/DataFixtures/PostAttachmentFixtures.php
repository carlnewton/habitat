    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach (self::POST_ATTACHMENT_GROUPS as $postAttachmentGroup) {
            ...
            foreach ($postAttachmentGroup['attachments'] as $attachmentPosition) {
                ...
                if (!$filesystem->exists('/uploads/' . $postAttachmentGroup['post'] . '-' . $attachmentFixtureFile['filename'])) {
                    $filesystem->copy('assets/img/fixtures/' . $attachmentFixtureFile['filename'], '/uploads/' . $postAttachmentGroup['post'] . '-' . $attachmentFixtureFile['filename']);
                }
